# !/usr/bin/env python3 File name: script.py Description: An Open Project containing python script to get normalized
# CSV data file of Road Safety Facts and Figures in the EU via web scrapping Author: Barnabas Oluwanishola Oretan
# Date: 19-05-2022

# import important modules and libraries in requirement.txt
import pandas as pd
import requests
